...
This guide walks you through the process of creating an application that accesses relational data through a link:/guides/gs/rest-hateoas[hypermedia-based] RESTful front end.
...
NOTE: Spring Data REST also supports Spring Data Gemfire and Spring Data MongoDB as backend data stores, but those are not part of this guide.
...
Congratulations! You've just developed an application with a RESTful front end and a JPA-based back end.
