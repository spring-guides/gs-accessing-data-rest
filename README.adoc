...
This guide walks you through the process of creating an application that accesses relational data through a link:/guides/gs/rest-hateoas[hypermedia-based] link:/understanding/REST[RESTful] front end.
